...
namespace Unity.Services.Ugc.Generated.Moderation
{
    ...
    /// <summary>
    /// ModerationApiBaseRequest class
    /// </summary>
    [Preserve]
    internal class ModerationApiBaseRequest
    {
        /// <summary>
    ...
    /// </summary>
    [Preserve]
    internal class ApproveContentRequest : ModerationApiBaseRequest
    {
        ...
        [Preserve]
        public ApproveContentRequest(string projectId, string environmentId, string contentId)
        {
            ProjectId = projectId;
            ...
            PathAndQueryParams = $"/v1/projects/{projectId}/environments/{environmentId}/content/{contentId}/approve";
    ...
    /// </summary>
    [Preserve]
    internal class GetContentModerationRequest : ModerationApiBaseRequest
    {
        /// <summary>Accessor for projectId </summary>
        [Preserve]
        public string ProjectId { get; }
        ...
        /// <summary>
        /// GetContentModeration Request Object.
        /// Get one content that needs moderation. Includes tags and stats
        /// </summary>
        ...
        [Preserve]
        public GetContentModerationRequest(string projectId, string environmentId, string contentId)
        {
            ProjectId = projectId;
            ...
            PathAndQueryParams = $"/v1/projects/{projectId}/environments/{environmentId}/content/{contentId}/moderation";
    ...
    /// </summary>
    [Preserve]
    internal class RejectContentRequest : ModerationApiBaseRequest
    {
        /// <summary>Accessor for projectId </summary>
        [Preserve]
        public string ProjectId { get; }
        ...
        [Preserve]
        public string ContentId { get; }
        /// <summary>Accessor for rejectContentRequestParameter </summary>
        [Preserve]
        public Unity.Services.Ugc.Generated.Models.RejectContentRequest RejectContentRequestParameter { get; }
        string PathAndQueryParams;

        /// <summary>
        /// RejectContent Request Object.
        /// Reject content that needed moderation
        /// </summary>
        /// <param name="projectId">The content's projectId</param>
        /// <param name="environmentId">The content's environmentId</param>
        /// <param name="contentId">The content's id</param>
        /// <param name="rejectContentRequestParameter">Reason for the rejection</param>
        [Preserve]
        public RejectContentRequest(string projectId, string environmentId, string contentId, Unity.Services.Ugc.Generated.Models.RejectContentRequest rejectContentRequestParameter = default(Unity.Services.Ugc.Generated.Models.RejectContentRequest))
        {
            ProjectId = projectId;
            ...
            RejectContentRequestParameter = rejectContentRequestParameter;
            PathAndQueryParams = $"/v1/projects/{projectId}/environments/{environmentId}/content/{contentId}/reject";
        ...
        public byte[] ConstructBody()
        {
            if(RejectContentRequestParameter != null)
            {
                return ConstructBody(RejectContentRequestParameter);
            }
            return null;
        }
    ...
    /// </summary>
    [Preserve]
    internal class ReportContentRequest : ModerationApiBaseRequest
    {
        /// <summary>Accessor for projectId </summary>
        [Preserve]
        public string ProjectId { get; }
        ...
        [Preserve]
        public string ContentId { get; }
        /// <summary>Accessor for reportContentRequestParameter </summary>
        [Preserve]
        public Unity.Services.Ugc.Generated.Models.ReportContentRequest ReportContentRequestParameter { get; }
        string PathAndQueryParams;

        /// <summary>
        /// ReportContent Request Object.
        /// Report content V2
        /// </summary>
        ...
        /// <param name="reportContentRequestParameter">The reason for the report</param>
        [Preserve]
        public ReportContentRequest(string projectId, string environmentId, string contentId, Unity.Services.Ugc.Generated.Models.ReportContentRequest reportContentRequestParameter = default(Unity.Services.Ugc.Generated.Models.ReportContentRequest))
        {
            ProjectId = projectId;
            ...
            ReportContentRequestParameter = reportContentRequestParameter;
            PathAndQueryParams = $"/v2/projects/{projectId}/environments/{environmentId}/content/{contentId}/report";
        ...
        public byte[] ConstructBody()
        {
            if(ReportContentRequestParameter != null)
            {
                return ConstructBody(ReportContentRequestParameter);
            }
            return null;
        }
    ...
    /// <summary>
    /// SearchContentModerationRequest
    /// Search for content that needs moderation
    /// </summary>
    [Preserve]
    internal class SearchContentModerationRequest : ModerationApiBaseRequest
    {
        /// <summary>Accessor for projectId </summary>
        [Preserve]
        public string ProjectId { get; }
        ...
        /// <summary>
        /// SearchContentModeration Request Object.
        /// Search for content that needs moderation
        /// </summary>
        ...
        [Preserve]
        public SearchContentModerationRequest(string projectId, string environmentId, int? offset = default(int?), int? limit = default(int?), List<string> sortBys = default(List<string>), string search = default(string), List<string> filters = default(List<string>), bool? includeTotal = default(bool?))
        {
            ProjectId = projectId;
            ...
            PathAndQueryParams = $"/v1/projects/{projectId}/environments/{environmentId}/content/moderation/search";
