...
namespace Unity.Services.Ugc.Generated.Subscription
{
    ...
    /// <summary>
    /// SubscriptionApiBaseRequest class
    /// </summary>
    [Preserve]
    internal class SubscriptionApiBaseRequest
    {
        /// <summary>
    ...
    /// </summary>
    [Preserve]
    internal class CreateSubscriptionRequest : SubscriptionApiBaseRequest
    {
        /// <summary>Accessor for newSubscriptionRequest </summary>
        [Preserve]
        public Unity.Services.Ugc.Generated.Models.NewSubscriptionRequest NewSubscriptionRequest { get; }
        string PathAndQueryParams;

        /// <summary>
        /// CreateSubscription Request Object.
        /// Create a new subscription
        /// </summary>
        /// <param name="newSubscriptionRequest">The content identifier for the current user to subscribe to</param>
        [Preserve]
        public CreateSubscriptionRequest(Unity.Services.Ugc.Generated.Models.NewSubscriptionRequest newSubscriptionRequest = default(Unity.Services.Ugc.Generated.Models.NewSubscriptionRequest))
        {
            NewSubscriptionRequest = newSubscriptionRequest;
            PathAndQueryParams = $"/v1/subscriptions";
        ...
        {
            if(NewSubscriptionRequest != null)
            {
                return ConstructBody(NewSubscriptionRequest);
            }
            return null;
        }
    ...
    /// </summary>
    [Preserve]
    internal class DeleteSubscriptionRequest : SubscriptionApiBaseRequest
    {
        ...
        /// <summary>
        /// DeleteSubscription Request Object.
        /// Deletes a subscription from the current user
        /// </summary>
        ...
        [Preserve]
        public DeleteSubscriptionRequest(string projectId, string environmentId, string contentId)
        {
            ProjectId = projectId;
            ...
            PathAndQueryParams = $"/v1/subscriptions/projects/{projectId}/environments/{environmentId}/content/{contentId}";
    ...
    /// </summary>
    [Preserve]
    internal class GetSubscriptionRequest : SubscriptionApiBaseRequest
    {
        /// <summary>Accessor for projectId </summary>
        [Preserve]
        public string ProjectId { get; }
        ...
        /// <summary>
        /// GetSubscription Request Object.
        /// Check if a certain piece of content is subscribed by the current user
        /// </summary>
        /// <param name="projectId">The content's project id</param>
        /// <param name="environmentId">The content's environment id</param>
        /// <param name="contentId">The content's id</param>
        [Preserve]
        public GetSubscriptionRequest(string projectId, string environmentId, string contentId)
        {
            ProjectId = projectId;
    ...
    /// </summary>
    [Preserve]
    internal class SearchSubscriptionsRequest : SubscriptionApiBaseRequest
    {
        ...
        /// <summary>
        /// SearchSubscriptions Request Object.
        /// Search the current users subscriptions
        /// </summary>
        /// <param name="offset">The amount of results to skip</param>
        /// <param name="limit">The amount of results to take</param>
        /// <param name="sortBys">The fields to use to sort by in order, prefix - for descending</param>
        ...
        [Preserve]
        public SearchSubscriptionsRequest(int? offset = default(int?), int? limit = default(int?), List<string> sortBys = default(List<string>), string search = default(string), List<string> filters = default(List<string>), bool? includeTotal = default(bool?))
        {
            Offset = offset;
            Limit = limit;
            SortBys = sortBys;
            ...
            PathAndQueryParams = $"/v1/subscriptions/search";
