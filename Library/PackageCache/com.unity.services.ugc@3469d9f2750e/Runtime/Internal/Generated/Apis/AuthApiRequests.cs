...
namespace Unity.Services.Ugc.Generated.Auth
{
    ...
    /// <summary>
    /// AuthApiBaseRequest class
    /// </summary>
    [Preserve]
    internal class AuthApiBaseRequest
    {
        /// <summary>
    ...
    /// </summary>
    [Preserve]
    internal class RedirectRequest : AuthApiBaseRequest
    {
        ...
        /// <summary>Accessor for idToken </summary>
        [Preserve]
        ...
        [Preserve]
        public RedirectRequest(string state, string code, string idToken)
        {
            State = state;
            Code = code;
            IdToken = idToken;
            PathAndQueryParams = $"/v1/auth";
        ...
        public List<IMultipartFormSection> ConstructBody()
        {
            ...
            requestParts.Add(new MultipartFormDataSection("state", ConstructBody(State), "text/plain"));
            
            requestParts.Add(new MultipartFormDataSection("code", ConstructBody(Code), "text/plain"));
            
            requestParts.Add(new MultipartFormDataSection("idToken", ConstructBody(IdToken), "text/plain"));
            return requestParts;
        }
