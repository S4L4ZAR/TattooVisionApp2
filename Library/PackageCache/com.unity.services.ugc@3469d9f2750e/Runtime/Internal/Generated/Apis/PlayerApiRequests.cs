...
namespace Unity.Services.Ugc.Generated.Player
{
    ...
    /// <summary>
    /// PlayerApiBaseRequest class
    /// </summary>
    [Preserve]
    internal class PlayerApiBaseRequest
    {
        /// <summary>
    ...
    /// </summary>
    [Preserve]
    internal class BanPlayerRequest : PlayerApiBaseRequest
    {
        ...
        /// <summary>Accessor for banPlayerRequestParameter </summary>
        [Preserve]
        public Unity.Services.Ugc.Generated.Models.BanPlayerRequest BanPlayerRequestParameter { get; }
        string PathAndQueryParams;

        /// <summary>
        /// BanPlayer Request Object.
        /// Ban a player from doing any actions
        /// </summary>
        /// <param name="projectId">The project for this player</param>
        /// <param name="environmentId">The environment for this player</param>
        /// <param name="banPlayerRequestParameter">Reason for the ban</param>
        [Preserve]
        public BanPlayerRequest(string projectId, string environmentId, Unity.Services.Ugc.Generated.Models.BanPlayerRequest banPlayerRequestParameter = default(Unity.Services.Ugc.Generated.Models.BanPlayerRequest))
        {
            ProjectId = projectId;

            EnvironmentId = environmentId;

            BanPlayerRequestParameter = banPlayerRequestParameter;
            PathAndQueryParams = $"/v1/projects/{projectId}/environments/{environmentId}/player/ban";
        ...
        {
            if(BanPlayerRequestParameter != null)
            {
                return ConstructBody(BanPlayerRequestParameter);
            }
            return null;
        }
    ...
    /// </summary>
    [Preserve]
    internal class GetPlayerStatisticsRequest : PlayerApiBaseRequest
    {
        /// <summary>Accessor for projectId </summary>
        [Preserve]
        public string ProjectId { get; }
        ...
        /// <summary>
        /// GetPlayerStatistics Request Object.
        /// Get Current Player Statistics
        /// </summary>
        /// <param name="projectId">projectId param</param>
        /// <param name="environmentId">environmentId param</param>
        [Preserve]
        public GetPlayerStatisticsRequest(string projectId, string environmentId)
        {
            ProjectId = projectId;

            EnvironmentId = environmentId;

            PathAndQueryParams = $"/v1/projects/{projectId}/environments/{environmentId}/player/statistics";
    ...
    /// </summary>
    [Preserve]
    internal class UnbanPlayerRequest : PlayerApiBaseRequest
    {
        /// <summary>Accessor for projectId </summary>
        [Preserve]
        public string ProjectId { get; }
        ...
        [Preserve]
        public string EnvironmentId { get; }
        /// <summary>Accessor for unbanPlayerRequestParameter </summary>
        [Preserve]
        public Unity.Services.Ugc.Generated.Models.UnbanPlayerRequest UnbanPlayerRequestParameter { get; }
        string PathAndQueryParams;

        /// <summary>
        /// UnbanPlayer Request Object.
        /// Unban a previously banned player
        /// </summary>
        /// <param name="projectId">The project for this player</param>
        /// <param name="environmentId">The environment for this player</param>
        /// <param name="unbanPlayerRequestParameter">The playerId of the player</param>
        [Preserve]
        public UnbanPlayerRequest(string projectId, string environmentId, Unity.Services.Ugc.Generated.Models.UnbanPlayerRequest unbanPlayerRequestParameter = default(Unity.Services.Ugc.Generated.Models.UnbanPlayerRequest))
        {
            ProjectId = projectId;

            EnvironmentId = environmentId;

            UnbanPlayerRequestParameter = unbanPlayerRequestParameter;
            PathAndQueryParams = $"/v1/projects/{projectId}/environments/{environmentId}/player/unban";
        ...
        public byte[] ConstructBody()
        {
            if(UnbanPlayerRequestParameter != null)
            {
                return ConstructBody(UnbanPlayerRequestParameter);
            }
            return null;
        }
