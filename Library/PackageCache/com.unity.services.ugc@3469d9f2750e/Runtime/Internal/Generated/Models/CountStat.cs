...
namespace Unity.Services.Ugc.Generated.Models
{
    ...
    public class CountStat
    {
        ...
        [Preserve]
        public CountStat(int allTime = default, int past365Days = default, int past180Days = default, int past90Days = default, int past60Days = default, int past30Days = default, int past14Days = default, int past7Days = default, int pastDay = default)
        {
            AllTime = allTime;
        ...
        /// <summary>
        /// Formats a CountStat into a string of key-value pairs for use as a path parameter.
        /// </summary>
        ...
        /// <summary>
        /// Returns a CountStat as a dictionary of key-value pairs for use as a query parameter.
        /// </summary>
